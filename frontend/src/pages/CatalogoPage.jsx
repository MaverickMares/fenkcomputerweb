...
const GRUPOS = [
  ...
  {
    label: "Refrigeración", icon: "❄️", catIds: [19],
    subs: [
      { label: "Líquida AIO 120mm",  catId: 19, subKey: "ref-aio-120",   matchFn: (p) => /120mm/i.test(p.nombre) },
      { label: "Líquida AIO 240mm",  catId: 19, subKey: "ref-aio-240",   matchFn: (p) => /240mm/i.test(p.nombre) },
      { label: "Líquida AIO 280mm",  catId: 19, subKey: "ref-aio-280",   matchFn: (p) => /280mm/i.test(p.nombre) },
      { label: "Líquida AIO 360mm",  catId: 19, subKey: "ref-aio-360",   matchFn: (p) => /360mm/i.test(p.nombre) },
      { label: "Aire Torre Simple",  catId: 19, subKey: "ref-torre-s",   matchFn: (p) => /torre simple/i.test(p.nombre) },
      { label: "Aire Torre Doble",   catId: 19, subKey: "ref-torre-d",   matchFn: (p) => /torre doble/i.test(p.nombre) },
      { label: "Low Profile",        catId: 19, subKey: "ref-lowprofile", matchFn: (p) => /low profile/i.test(p.nombre) },
      { label: "Pasta Térmica",      catId: 19, subKey: "ref-pasta",      matchFn: (p) => /pasta t[eé]rmica/i.test(p.nombre) },
      { label: "Fans RGB",           catId: 19, subKey: "ref-fans",       matchFn: (p) => /uni fan|ll120/i.test(p.nombre) },
    ],
  },
  {
